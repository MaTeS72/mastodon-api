  ...
  ($checkedConvert) {
    final val = _Instance(
      ...
      statistics: $checkedConvert(
        'stats',
        (v) => InstanceStatistics.fromJson(Map<String, Object?>.from(v as Map)),
      ),
      thumbnail: $checkedConvert('thumbnail', (v) => v as String?),
      isRegistrationsEnabled: $checkedConvert(
        'registrations',
        (v) => v as bool,
      ),
      ...
      isInvitesEnabled: $checkedConvert('invites_enabled', (v) => v as bool),
