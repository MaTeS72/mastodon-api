...
class _Relationship implements Relationship {
  const _Relationship({required this.id, @JsonKey(name: 'note') this.bio = '', @JsonKey(name: 'following') this.isFollowing = false, @JsonKey(name: 'followed_by') this.isFollowed = false, @JsonKey(name: 'showing_reblogs') this.isShowingReblogs = false, @JsonKey(name: 'notifying') this.isNotifying = false, @JsonKey(name: 'blocking') this.isBlocking = false, @JsonKey(name: 'blocked_by') this.isBlocked = false, @JsonKey(name: 'muting') this.isMuting = false, @JsonKey(name: 'muting_notifications') this.isMutingNotifications = false, @JsonKey(name: 'requested') this.isRequested = false, @JsonKey(name: 'domain_blocking') this.isDomainBlocking = false, @JsonKey(name: 'endorsed') this.isEndorsed = false, final  List<Language>? languages}): _languages = languages;
