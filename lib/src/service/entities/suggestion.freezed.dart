...
/// The reason this account is being suggested.
 SuggestedReason get source;/// The account being recommended to follow.
 Account get account;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Suggestion&&(identical(other.source, source) || other.source == source)&&(identical(other.account, account) || other.account == account));
}
...
@useResult
$Res call({
 SuggestedReason source, Account account
});
...
/// Create a copy of Suggestion
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? source = null,Object? account = null,}) {
  return _then(_self.copyWith(
source: null == source ? _self.source : source // ignore: cast_nullable_to_non_nullable
as SuggestedReason,account: null == account ? _self.account : account // ignore: cast_nullable_to_non_nullable
as Account,
  ));
}
/// Create a copy of Suggestion
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SuggestedReason source,  Account account)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Suggestion() when $default != null:
return $default(_that.source,_that.account);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SuggestedReason source,  Account account)  $default,) {final _that = this;
switch (_that) {
case _Suggestion():
return $default(_that.source,_that.account);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SuggestedReason source,  Account account)?  $default,) {final _that = this;
switch (_that) {
case _Suggestion() when $default != null:
return $default(_that.source,_that.account);case _:
  return null;
...
class _Suggestion implements Suggestion {
  const _Suggestion({required this.source, required this.account});
  factory _Suggestion.fromJson(Map<String, dynamic> json) => _$SuggestionFromJson(json);

/// The reason this account is being suggested.
@override final  SuggestedReason source;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Suggestion&&(identical(other.source, source) || other.source == source)&&(identical(other.account, account) || other.account == account));
}
...
/// Create a copy of Suggestion
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? source = null,Object? account = null,}) {
