...
_V2InstanceConfiguration _$V2InstanceConfigurationFromJson(Map json) =>
    $checkedCreate('_V2InstanceConfiguration', json, ($checkedConvert) {
      final val = _V2InstanceConfiguration(
        urls: $checkedConvert(
          'urls',
...
Map<String, dynamic> _$V2InstanceConfigurationToJson(
  _V2InstanceConfiguration instance,
) => <String, dynamic>{
